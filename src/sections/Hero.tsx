...
export function Hero() {
  return (
    <section className="relative isolate overflow-x-hidden pt-[calc(var(--header-height)+12px)] sm:pt-[calc(var(--header-height)+20px)]">
      <TechBackground />
        ...
        >
          ...
          <div className="relative grid min-w-0 items-center gap-8 lg:grid-cols-[minmax(0,1.12fr)_minmax(430px,0.88fr)] xl:gap-12">
            <motion.div variants={fadeUp} className="min-w-0 max-w-[880px]">
              ...
              <div className="mt-7 grid min-w-0 gap-3 rounded-[24px] border border-white/10 bg-graphite-950/45 p-3 shadow-[0_18px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl sm:p-4 lg:mt-8 xl:grid-cols-[0.82fr_1.18fr] xl:items-start">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-5 flex items-center gap-4 rounded-3xl border border-white/10 bg-white/[0.045] p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-metal-300">
                          Do projeto à entrega, com orientação técnica em cada etapa.
                        </p>
                      </div>
                    </div>
